...
namespace nightxclient
{
    public partial class Form3 : Form
    {
        ...
        {
            System.Diagnostics.Process.Start("https://wiki.multitheftauto.com/wiki/Weapons");
        }

        private void guna2Button4_Click(object sender, EventArgs e)
        {
            if (guna2TextBox1.Text == "" || guna2TextBox5.Text == "")
            {
