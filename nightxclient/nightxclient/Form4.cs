...
namespace nightxclient
{
    public partial class Form4 : Form
    {
        ...
        {
            System.Diagnostics.Process.Start("https://wiki.multitheftauto.com/wiki/All_Skins_Page");
        }
        ...
        void ClientOlusturma()
        {
            ...
            string client = "function Karakter()\nlocal txd = engineLoadTXD ('" + txd + "')\nengineImportTXD(txd," + id + ")\n local dff = engineLoadDFF('" + dff + "'," + id + ")\nengineReplaceModel(dff," + id + ")\nend\naddEventHandler('onClientResourceStart',getResourceRootElement(getThisResource()),Karakter)";
        ...
        void MetaOlusturma()
        {
            string txd = guna2TextBox3.Text;
            string dff = guna2TextBox2.Text;
            string meta = "<meta>\n    <info author='NightX' name='Karakter' />\n	   <script src='client.lua' type='client' />\n	   <file src='" + txd + "' />\n	   <file src='" + dff + "' />\n</meta>";
